    ...
    public function subscriptions(Request $request)
    {
        if($request->isMethod('post')){
            ...
            Subscription::create([
                ...
                'job' => $request->job,
                'promoted_services' => $request->pro_sec,
                'status' => 1,
            ]);
    ...
    public function edit_subscription(Request $request, $id=null)
    {
        if($request->isMethod('post')){
            $request->validate([
                ...
                'pro_sec'=> 'required',
                'projects_allowed' => 'nullable|integer|min:0',
                'cashback_percentage' => 'nullable|integer|min:0|max:100',
                'sms_notifications' => 'nullable|in:yes,no',
                'Website_enabled' => 'nullable|in:yes,no',
                'personal_enabled' => 'nullable|in:yes,no',
                'partialpayment_enabled' => 'nullable|in:yes,no',
                'aidescription_enabled' => 'nullable|in:yes,no',
            ]);
