...
Route::group(['prefix' => 'subscription','as'=>'seller.', 'middleware' => ['globalVariable','setlang']], function () {
...
Route::post('/webhook/flutterwave','Frontend\BuySubscriptionController@webhook')->name('webhook');
Route::get('/showwebhook/flutterwave','Frontend\BuySubscriptionController@showwebhook');
