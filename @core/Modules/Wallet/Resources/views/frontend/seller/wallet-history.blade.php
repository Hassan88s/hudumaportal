                        ...
                        <table>
                            ...
                            @foreach($wallet_histories as $history)
                                <tr>
                                    ...
                                    <td>
                                        <div class="dashboard_table__main__paymentGateway">{{ __($history->payment_gateway === 'added_by_admin' ? 'Added by Admin' : $history->payment_gateway) }}</div>
                                    </td>
                                    <td>
                                        <div class="dashboard_table__main__priority">
                                            @if($history->payment_status == 'pending')
                                                <a href="javascript:void(0)" class="priorityBtn pending">{{ __($history->payment_status) }}</a>
                                            @else
                                                <a href="javascript:void(0)" class="priorityBtn completed">{{ __($history->payment_status) }}</a>
                                            @endif
                                        </div>
                                    </td>
                                    <td>
                                        <div class="dashboard_table__main__date">{{ $history->created_at }} </div>
                                    </td>
                                    <td>
