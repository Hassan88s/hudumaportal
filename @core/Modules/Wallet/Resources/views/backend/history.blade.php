...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            ...
                            <div class="right-content">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#payoutRequestModal">{{ __('Manage User Wallet') }}</button>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <ul>
                                                ...
                                                <li><strong>{{__('Name')}}: </strong>{{optional($data->user)->username}}</li>
                                        ...
                                        @php
                                        $className =$data->Action == 'Deposit' ? 'text-success' : 'text-danger';
                                        @endphp
                                         <td><strong class={{$className}}>{{ $data->Action }}</strong></td>
                                        <td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-warning" id="couponModal">{{ __('Manage User Wallet') }}</h5>
   ...
   <div class="single-info-input margin-top-30">
 <label for="user_id" class="info-title"> {{__('Select Method')}} </label><br>                   
 <input type="radio" id="Deposit" name="action" value="Deposit">
 <label for="Deposit">Deposit</label><br>
 <input type="radio" id="withdrawal" name="action" value="withdrawal">
