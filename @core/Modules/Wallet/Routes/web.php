...
Route::group(['prefix' => 'wallet'],function (){
    ...
    Route::match(['get','post'],'/clickpesa-ipn','Frontend\BuyerWalletPaymentController@clickpesa_ipn_for_wallet')->name('buyer.clickpesa.ipn.wallet');
});
...
Route::group(['prefix' => 'seller/wallet'],function (){
    ...
    Route::match(['get','post'],'/clickpesa-ipn','Frontend\SellerWalletPaymentController@clickpesa_ipn_for_wallet')->name('seller.clickpesa.ipn.wallet');
});