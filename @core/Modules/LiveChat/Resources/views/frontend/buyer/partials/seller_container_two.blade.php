 <ul class="user-profile-chat margin-top-30" id="users">
    @foreach($sellers as $seller)
        <li>
            <a href="javascript:void(0);" class="chat-toggle"data-id="{{ optional($seller->seller)->id }}"data-user="{{ optional($seller->seller)->username }}">
                ...
                <h4 class="chat-author-title"> {{ optional($seller->seller)->username  }} </h4>
            </a>
        </li>
    @endforeach
</ul>
