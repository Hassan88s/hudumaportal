...
Route::group(['prefix'=>'seller','middleware'=> ['auth','inactiveuser','BuyerCheck','userEmailVerify','setlang','globalVariable']],function() {
    ...
    Route::post('/share-stream-to-chat', 'Frontend\SellerChatController@shareStreamToChat')->name('seller.share.stream.chat');
    Route::get('/chat-contacts-list', 'Frontend\SellerChatController@chatContacts')->name('seller.chat.contacts.list');
});
