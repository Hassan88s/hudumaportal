                                                ...
                                                @if($request_details->is_hired != 1)
                                                    <a href="#0" class="edit_offer_price"
                                                       ...
                                                       data-expected_salary="{{ $request_details->expected_salary }}"                                                     >
                                                        <span class="dash-icon dash-edit-icon color-1" title="{{ __('Change offer price') }}"> <i class="las la-edit btn btn-warning"></i> </span>
                                                    </a>
                                                @endif
                                                ...
                                                <div class="single-message-item @if($msg->type == 'buyer') customer @endif">
                                                    <div class="top-part">
                                                        <div class="thumb">
                                                            <span class="title">
                                                                 @if($msg->type == 'seller')
                                                                      ...
                                                                      {{substr(optional(optional($request_details->job)->buyer)->username ?? 'B',0,1)}}
                                                                @else
                                                                    {{substr(optional($request_details->seller)->username ?? 'S',0,1)}}
                                                                @endif
                                                            </span>
                                                            @if($msg->notify == 'on')
                                                        ...
                                                        <div class="content">
                                                            <h6 class="title">
                                                                @if($msg->type == 'seller')
                                                                   {{optional($request_details->seller)->username ?? 'S'}}
                                                                  
                                                                @else
                                                                   {{optional(optional($request_details->job)->buyer)->username ?? 'B'}}
                                                                @endif
                                                            </h6>
