            ...
            <div class="dashboard__inner">
                ...
                <div class="dashboard__inner__item dashboard_border padding-20 radius-10 bg-white">
                    <div class="dashboard__wallet">
                        <form action="{{ route('buyer.all.jobs.request') }}" method="GET">
                            <div class="dashboard__headerGlobal__flex">
                                <div class="dashboard__headerGlobal__content">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        <h4 class="dashboard_table__title">{{ __('Search Job Request Module') }}</h4> <i class="las la-angle-down search_by_all"></i>
                                    </button>
                                </div>
                            ...
                            <div class="accordion-item">
                                ...
                                @elseif(request()->get('seller_offer')) show
                                @endif
                                                ...
                                                <div class="single-settings">
                                                    <div class="single-dashboard-input">
                                                        <div class="row g-4 mt-3">
                                                            ...
                                                            <div class="col-lg-4 col-sm-6">
                                                                <div class="single-info-input">
                                                                    <label for="seller_offer" class="info-title"> {{__('Seller Offer')}} </label>
                                                                    <input class="form--control" name="seller_offer" value="{{ request()->get('seller_offer') }}" type="text" placeholder="{{ __('Seller Offer') }}">
                                                                </div>
                                                            </div>
                ...
                <div class="dashboard__headerContents">
                    <div class="dashboard__headerContents__flex">
                        <div class="dashboard__headerContents__left">
                            <h4 class="dashboards-title"><strong>{{ __('Request For Your Jobs') }}</strong></h4>
                                ...
                                @foreach ($all_job_requests as $job_req)
                                    <tr>
                                        ...
                                        <td data-label="{{ __('Seller Name') }}">
                                               <a href="{{ route('about.seller.profile', optional($job_req->seller)->username) }}" class="text-primary">
                                                <span style="height: 60px; width: 60px">
                                                   {!! render_image_markup_by_attachment_id(optional($job_req->seller)->image) !!} </span>
                                                     {{ optional($job_req->seller)->username }}
                                               </a>
