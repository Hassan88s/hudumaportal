                    ...
                    <div class="row mt-5">
                                ...
                                <div class="single-dashboard-input mt-2">
                                    ...
                                    <div class="single-info-input">
                                     ...
                                     <div class="single-info-input">
                                        ...
                                        <label for="dead_line" class="info-title"> {{__('Delivery  Days')}} <span class="text-danger">*</span> </label>
                                        <input class="form--control" {{ old('Days') }} name="Days" id="dead_line" type="text" placeholder="{{__('Days')}}">
                                    </div>
                        ...
                        <div class="col-xxl-6">
                            ...
                            <div class="single-dashboard-input show_hide_job_for_online_offline">
                                ...
                                <div class="single-info-input margin-top-30">
                                    <label for="city_id" class="info-title"> {{__('Select Region')}} <span class="text-danger">*</span> </label>
                                    <select  name="city_id" id="city_id" class="city"></select>
                                </div>
                                
                                                <div class="single-info-input margin-top-30">
                    <label for="area_id" class="info-title"> {{__('Select City')}} <span class="text-danger">*</span> </label>
                                    ...
                                    <div class="single-info-input">
                                       @if(Auth::user()->is_company == '1')
                                            ...
                                            {{ __('Generate AI Description') }}
                                                    ...
                                                    @endif
                                        <label for="description" class="info-title"> {{__('Job Description')}} <span class="text-danger">*</span> <span class="text-danger">{{ __('minimum 50 characters') }}</span> </label>
                                        <textarea class="form--control textarea--form summernote" id="summernote" name="description" placeholder="{{__('Type Description')}}">{{ old('description')}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                      <h6 class="info-title pt-3"><strong>{{__('Make a Monthly Payment')}}</strong></h6>
                    <div class="row mt-1">
                                  ...
                                  <div class="modal-body">
                                    <form id="aiPromptForm">
                                      <div class="mb-3">
                                        ...
                                        <textarea id="aiPromptInput" class="form-control" rows="4" placeholder="{{ __('Type your full prompt here...') }}" style="line-height:1.2; padding:4px 8px; resize:vertical;"></textarea>
                                      </div>
                                    </form>
                                  </div>
            ...
            <script type="text/javascript">
                (function(){
                    ...
                    $(document).ready(function(){
                        ...
                        // when city is changed, load areas
                    $('#city_id').on('change', function() {
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                if (res.status == 'success') {
                                    let all_options = '';
                                    let all_areas = res.areas;
                                    $.each(all_areas, function(index, value) {
                                        all_options += "<option value='" + value.id + "'>" + value.service_area + "</option>";
                                    });
                                    $(".area").html(all_options);
                                    // if you use niceSelect, also update:
