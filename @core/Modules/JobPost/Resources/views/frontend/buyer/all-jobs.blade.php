                                        ...
                                        <div class="dashboard_jobPost__flex">
                                                ...
                                                <div class="dashboard_jobPost__author__contents">
                                                    ...
                                                    <div class="dashboard_jobPost__views mt-2">
                                                        <div class="dashboard_jobPost__views__item">
                                                            ...
                                                            <span class="dashboard_jobPost__views__para"><i class="fa-solid fa-list-check"></i> {{ __('Freelancer  Offered') }}</span>
                                                        ...
                                                        <div class="dashboard_jobPost__views__item">
                                                            <span class="dashboard_jobPost__views__para"> {{ __('Delivery Days:') }}</span>
                                                            <strong class="replaceText text-dark"> {{$data->Days}}</strong>
                                                        </div>
                                                        ...
                                                        <div class="dashboard_jobPost__views__item">
                                                         ...
                                                         <div class="dashboard_jobPost__views__item">
                                                            ...
                                                            @if($data->is_paid == 1  && $data->promoteddays >= 1 && $data->promoted == 1) <span class="btn btn-warning">{{ __('Promoted') }}</span> @endif
                                                        </div>
                                            ...
                                            <div class="dashboard_jobPost__switch switchParent">
                                                <span class="dashboard_jobPost__switch__para switchPara">{{ __('Job is') }}
                                                 @if($data->is_job_on === 1)
                                                    @if(now() > $data->dead_line)
                                                        <strong class="replaceText">{{ __('Close') }}</strong> <br>
                                                        <small class="text-danger" style="font-size: 12px">{{ __('Deadline Passed') }}</small>
                                                    @else
                                                        <strong class="replaceText">{{ __('Active') }}</strong>
                                                    @endif
                                                 @else
                                                ...
                                                @if($data->is_job_on==1)
                                                    <label class="custom_switch" for="switch2_{{$data->id}}">
                                                        <input class="switch_input service_on_off_btn" id="switch2_{{$data->id}}" data-id="{{$data->id}}"  type="checkbox"
                                                               @if(now() < $data->dead_line && $data->is_job_on === 1)
                                                                   checked
                                                                @endif >
