...
Route::middleware('auth:api')->get('/user', function (Request $request) {
 ...
 Route::get('cron-job/AutoCancelOrders',[BuyerJobController::class,"AutoCancelOrders"]);
 Route::get('cron-job/promoted/services',[SellerController::class,"cronjob"]);
  Route::get('cron-job/promoted/job',[BuyerJobController::class,"cronjobforexpire"]);
 
     Route::get('cron-job/add-date',[SellerController::class,"checkUpcomingOrderDate"]);
     Route::get('cron-job/expire-promoted/services',[SellerController::class,"expirepromoted"]);
Route::group(['prefix'=>'v1', 'middleware' => 'setlang'],function(){
    ...
    Route::post('/account-delete',[MiscellaneousController::class,'accountDelete'])->middleware('auth:sanctum');
        Route::get('services/add-date','Frontend\SellerController@checkUpcomingOrderDate')->name('seller.active.services');
