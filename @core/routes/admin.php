...
Route::group(['prefix'=>'services'],function(){
    Route::get('/','ServiceController@index')->name('admin.services');
      Route::get('/promotedservices','ServiceController@promotedservices')->name('admin.promotedservices');
      Route::get('/payment-promotedstatus/{id}','ServiceController@change_promoted_status')->name('admin.promotedpayment.edit');
...
Route::group(['prefix'=>'orders'],function(){
    ...
    Route::post('cancel/accept/{id}', 'OrdersController@acceptCancelRequest')->name('admin.orders.cancel.accept');
    Route::post('cancel/reject/{id}', 'OrdersController@rejectCancelRequest')->name('admin.orders.cancel.reject');
...
|----------------------------------------------------------------------------------------------------------------------------*/
    Route::prefix('general-settings')->group(function (){
        ...
        //  Route::get('/adspace','GeneralSettingsController@adspace')->name('admin.general.adspace');
         Route::get('/adspace/{id?}','GeneralSettingsController@adspace')->name('admin.general.adspace');
        Route::post('/update/adsensecode','GeneralSettingsController@update_adsensecode')->name('admin.general.adsensecode');
        Route::post('/update/adsspace','GeneralSettingsController@update_adsspace')->name('admin.general.updateadsspace.settings');
        ...
        //RefferalSetting
         Route::get('/RefferalSetting/{id?}','GeneralSettingsController@RefferalSetting')->name('admin.general.RefferalSetting');
          ...
          Route::get('/CompanySetting/{id?}','GeneralSettingsController@CompanySetting')->name('admin.general.CompanySetting');
            Route::post('update/company-settings','GeneralSettingsController@update_CompanySetting')->name('admin.general.update.CompanySetting');
   ...
   |----------------------------------------------------------------------------------------------------------------------------*/
    ...
    //
    Route::get('/frontend/change-userdelete-status/{id}/{userid}','FrontendUserManageController@userdeleteStatus')->name('admin.frontend.userdelete.status');
    //
    ...
    ///enterprise routes
     ...
     Route::get('/enterprise-requests', 'EnterpriseAdminController@index')->name('admin.enterprise.index');
    Route::post('/enterprise-approve/{id}', 'EnterpriseAdminController@approve')->name('admin.enterprise.approve');
    Route::post('/enterprise-reject/{id}', 'EnterpriseAdminController@reject')->name('admin.enterprise.reject');
   ...
   //EMAIL TEMPLATE SETTINGS
    Route::group(['as'=>'admin.','prefix'=>'email-template'],function () {
        ...
        Route::match(['get', 'post'], '/user/jobsnewsletter/template', 'EmailTemplateController@user_jobsnewsletter_template')->name('email.user.jobsnewsletter.template');
        ...
        Route::match(['get', 'post'], '/user/email-verify/template', 'EmailTemplateController@user_email_verify_template')->name('email.user.verify.template');
         ...
         Route::match(['get', 'post'], '/{slug}', 'EmailTemplateController@dynamicEmailTemplate')
        ->name('email.template.dynamic');
        ...
        Route::group(['prefix' => 'seller'], function () {
            ...
            Route::match(['get', 'post'], '/new/service/pendingapprove', 'EmailTemplateController@seller_service_pending_approve')->name('seller.service.pendingapprove');
            Route::match(['get', 'post'], '/booking/approved', 'EmailTemplateController@BookingApprovedByFreelancer')->name('seller.booking.approved');
            Route::match(['get', 'post'], '/customoffer/sent', 'EmailTemplateController@customofferSent')->name('seller.customoffer.sent');
            Route::match(['get', 'post'], '/customoffer/accepted', 'EmailTemplateController@customofferAccepted')->name('seller.customoffer.Accepted');
              Route::match(['get', 'post'], '/customoffer/declined', 'EmailTemplateController@customofferDeclined')->name('seller.customoffer.Declined');
              Route::match(['get', 'post'], '/applyforjob', 'EmailTemplateController@applyjobtemmplate')->name('seller.applyjob');
              Route::match(['get', 'post'], '/jobhiring', 'EmailTemplateController@jobhiringtemplate')->name('seller.jobhiring');
              
               Route::match(['get', 'post'], '/service/completion', 'EmailTemplateController@servicecompletiontemplate')->name('seller.service.completion');
               Route::match(['get', 'post'], '/request/modification', 'EmailTemplateController@requestmodificationtemplate')->name('seller.request.modification');
               Route::match(['get', 'post'], '/approves/service/completion', 'EmailTemplateController@approvesservicecompletiontemplate')->name('seller.approves.service.completion');
               Route::match(['get', 'post'], '/delivery/time/extension/request', 'EmailTemplateController@deliverytimeextensionrequesttemplate')->name('seller.delivery.time.extension.request');
            
           Route::match(['get', 'post'], '/delivery/time/extension/approved', 'EmailTemplateController@deliverytimeextensionapprovedtemplate')->name('seller.delivery.time.extension.approved');
           Route::match(['get', 'post'], '/delivery/time/extension/Declined', 'EmailTemplateController@deliverytimeextensionDeclinedtemplate')->name('seller.delivery.time.extension.Declined');
           Route::match(['get', 'post'], '/additional/service/request', 'EmailTemplateController@additionalservicerequesttemplate')->name('seller.additional.service.request');
           Route::match(['get', 'post'], '/additional/service/request/approved', 'EmailTemplateController@additionalservicerequestapprovedtemplate')->name('seller.additional.service.request.approved');
           Route::match(['get', 'post'], '/additional/service/request/declined', 'EmailTemplateController@additionalservicerequestdeclinedtemplate')->name('seller.additional.service.request.declined');
           
           Route::match(['get', 'post'], '/promotes/service/template', 'EmailTemplateController@promoteservicestemplate')->name('seller.promotes.service.template');
           Route::match(['get', 'post'], '/partial/payment/request/template', 'EmailTemplateController@partialpaymentrequesttemplate')->name('seller.partial.payment.request.template');
           Route::match(['get', 'post'], '/partial/payment/request/approved/template', 'EmailTemplateController@partialpaymentrequestapprovedtemplate')->name('seller.partial.payment.request.approved.template');
           Route::match(['get', 'post'], '/partial/payment/request/declined/template', 'EmailTemplateController@partialpaymentrequestdeclinedtemplate')->name('seller.partial.payment.request.declined.template');
           Route::match(['get', 'post'], '/payout/request/template', 'EmailTemplateController@payoutrequest')->name('seller.payout.request.template');
           Route::match(['get', 'post'], '/payment/sent/template', 'EmailTemplateController@paymentsenttemplate')->name('seller.payment.sent.template');
           
              
              
            
             Route::match(['get', 'post'], '/new/message', 'EmailTemplateController@new_message')->name('seller.new.message');
