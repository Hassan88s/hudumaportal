                        ...
                        <form action="{{route('admin.email.user.verify.template')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="tab-content margin-top-30">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote" name="user_email_verify_message">{!! get_static_option('user_email_verify_message') ?? '<p>Hello @name,</p></p>You have user registered as a @type Username: @username Email: @email</p>'  !!} </textarea>
                                </div>
                                    ...
                                    <small class="form-text text-muted text-danger margin-top-20"><code>@type</code> {{__('will be replaced by dynamically with  user type.')}}</small>
