                        ...
                        @if(moduleExists("LiveChat"))
                            ...
                            @if (request()->is('admin-home/chat-users/*')) active @endif">
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-comment-alt"></i>
                                    <span>{{ __('Live Chat') }} <small class="badge badge-danger"></small></span>
                                </a>
                                <ul class="collapse">
                                    ...
                                    <ul class="collapse">
                                        ...
                                        @can('job-list')
                                            <li class="{{ active_menu('admin-home/jobs/settings') }}">
                                              ...
                                              <li class="{{ active_menu('admin-home/jobs/job-packages') }}">
                                                <a href="{{ route('admin.job.packages') }}">{{ __('Job Packages') }}</a>
                                            </li>
                                        @endcan
...
{{--                                            @endcan--}}
                            ...
                            <ul class="collapse">
                                ...
                                @can('user-list')
                                    <li class="{{ active_menu('admin-home/frontend/deactive-users') }}">
                                        <a href="{{ route('admin.all.frontend.deactive.user') }}">{{ __('Delete/Deactive Users') }}</a>
                                    </li>
                                @endcan
                                
                                
                                 <li class="{{ active_menu('admin-home/enterprise/index') }}">
                                        <a href="{{ route('admin.enterprise.index') }}">{{ __('Company Manage') }}</a>
                                    </li>
                            </ul>
                        </li>
                    @endcanany
                        ...
                        <li
                            ...
                            <ul class="collapse">
                                ...
                                @endcan
                                    ...
                                    <li class="{{ active_menu('admin-home/promotedservices') }} @if (request()->is('admin-home/promotedservices')) active @endif">
                                        <a href="{{ route('admin.promotedservices') }}">{{ __('All Feature Services') }}</a></li>
                    ...
                    @canany(['general-settings-reading-settings', 'general-settings-global-navbar-settings',
                        ...
                        'general-settings-cache-settings','database-upgrade','general-settings-adspace-settings'])
                        <li class="@if (request()->is('admin-home/general-settings/*')) active @endif">
                            ...
                            <ul class="collapse ">
                                ...
                                @endcan
                                @can('general-settings-adspace-settings')
                                    <li class="{{ active_menu('admin-home/general-settings/adspace') }}"><a
