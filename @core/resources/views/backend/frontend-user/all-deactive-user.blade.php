                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">{{__('Delete / Deactivated Users')}}</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @endif
                                                         ...
                                                         <a href="{{route('admin.frontend.userdelete.status',[$data->id,$data->user_id])}}"> <span class="btn btn-danger">{{ __('Approve Request For deleted Acccount') }}</span></a>
                                                        @endif
                                                    </td>
