     ...
     <input type="hidden" name="current_tab" wire:model="current_tab">
        ...
        <div class="add-service-wrapper mt-4">
            ...
            <div wire:ignore class="nav nav-pills" id="add-service-tab"
                ...
                <!--   aria-selected="false"><span class="nav-link-number">{{ __('3') }}</span>{{__('Meta Section')}}</a>-->
                <a class="nav-link @if($current_tab === "service-media-uploads-tab") active @endif  stepIndicator" id="service-media-uploads-tab" data-bs-toggle="pill"
                   ...
                   aria-selected="false"><span class="nav-link-number">{{ __('4') }}</span>{{__('Media Uploads')}}</a>
                <a class="nav-link @if($current_tab === "service-set-availability-tab") active @endif stepIndicator" id="service-set-availability-tab" data-bs-toggle="pill"
                   ...
                   aria-selected="false"><span class="nav-link-number">{{ __('5') }}</span>{{__('Set Availability')}}</a>
                   <!-- <a class="nav-link @if($current_tab === "service-attribute-tab") active @endif stepIndicator" id="service-attribute-tab" data-bs-toggle="pill"-->
                   <!--href="#service-attribute" role="tab"-->
                   <!--aria-controls="service-attribute"-->
                   <!--aria-selected="false"><span class="nav-link-number">{{ __('6') }}</span>{{__('Service Price')}}</a>-->
            </div>
            ...
            <div  class="add-service-content-wrapper mt-4">
                <div class="tab-content add-service-content" id="add-service-tabContent">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            {{ __('Generate AI Description') }}
                                                ...
                                                <label for="description" class="info-title"> {{__('Service Description')}} <span class="text-danger">*</span> <small class="text-info">{{__('minimum 50 characters')}} </small>  </label>
                                                
                                                <textarea wire:model.defer="services.description" name="description" id="summernote" class="form--control textarea--form textarea-input" cols="20" rows="2" placeholder="{{__('Type Description')}}"></textarea>
                   ...
                   <!--                             <input class="form--control" type="text" name="pricenew" id="service_total_price" >-->
                   <!--                         </div>-->
                   <!--                     </div>-->
                   <!--                 </div>-->
                        ...
                        <div class="row g-4">
                            <div wire:ignore class="col-xxl-2 col-md-3 col-sm-4" >
                                <div class="service-attribute-wrapper">                                
                                    ...
                                    <div class="nav nav-pills flex-column" id="add-service-attribute-tab"
                                        ...
                                        <!--    {{__('FAQ ')}}-->
                                        <!--</a>-->
                                        <a class="nav-link " id="faq-service-tab" data-bs-toggle="pill"
                            ...
                            <div class="col-xxl-10 col-md-9 col-sm-8">
                                <div class="row g-4">
                                                ...
                                                <div class="single-settings">
                                                    <div  wire:ignore class="dashboard_table__title__flex">
                                                        <div class="dashboard__headerContents__left">
                                                            <h4 class="input-title">  {{__('Enter Package Details ')}} </h4>
                                                            <div class="online_service mt-3">
                                                                <div class="dashboard-switch-single d-flex gap-1">
                                                                    ...
                                                                    <input  wire:click="openDiv" class="custom-switch is_service_online" name="service_online" id="is_service_online" type="checkbox" wire:model.defer="services.is_service_online" />
                                    ...
                                    <!--    <div class="single-dashboard-input ">-->
                                    <!--        <div class="single-info-input">-->
                                    <!--            <label class="info-title"> {{__('Service Price')}}<span class="text-danger">*</span></label>-->
                                    <!--            <input class="form--control" type="text" name="price" id="service_total_price" >-->
                                    <!--        </div>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                                                ...
                                                                <div class="row g-4">
                                                                    <div class="col-lg-4 col-sm-6">
                                                                        <div class="single-info-input">
                                                                            ...
                                                                            <input class="form--control" wire:model.defer="include_service_title.0" name="include_service_title[]" type="text" placeholder="{{__('Service Title')}}">
                                                                        </div>
                                                                    </div>
                                                                         <div class="col-lg-4 col-sm-6">
                                                                <div class="single-info-input">
                                                                    ...
                                                                    <div class="col-lg-4 col-sm-6">
                                                                        <div class="single-info-input is_service_online_hide">
                                                                            ...
                                                                            <input class="form--control include-price" wire:model.defer="include_service_price.0" name="include_service_price[]" type="number" name="pricenew"  placeholder="{{__('Add Price')}}">
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-lg-4 col-sm-6">
                                                                        <div class="single-info-input is_service_online_hide">
                                                                            ...
                                                                            <input class="form--control numeric-value" type="text" step="0.01" name="include_service_quantity[]" id="include_service_quantity.0" value="1" placeholder="{{__('Add Quantity')}}" >
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="single-dashboard-input what-include-element mt-4">
                                                                        <div class="row align-items-center g-4">
                                                                            <div class="col-lg-4 col-sm-6">
                                                                                <div class="single-info-input">
                                                                                    <label class="label_title">{{ __('Title') }} <span class="text-danger">*</span> </label>
                                                                                    <input class="form--control" type="text"  name="include_service_title[]" wire:model.defer="include_service_title.{{ $key }}" placeholder="{{__('Service title')}}">
                                                                                </div>
                                                                            </div>
                                                                            <div class="@if($online_offline_show_hide) d-none @endif col-lg-3 col-sm-6 is_service_online_hide">
                                                                                <div class="single-info-input">
                                                                                    <label class="label_title">{{ __('Unit Price') }} <span class="text-danger">*</span> </label>
                                                                                    <input class="form--control include-price" type="text"  name="include_service_price[]" wire:model.defer="include_service_price.{{ $key }}" placeholder="{{__('Add Price')}}">
                                                                                </div>
                                                                            </div>
                                                                            <div class="@if($online_offline_show_hide) d-none @endif col-lg-3 col-sm-6 is_service_online_hide">
                                                                                <div class="single-info-input">
                                                                ...
                                                                <div class="single-settings online_service_price_show_hide">
                                                                    <div class="single-dashboard-input">
                                                                        <div class="single-info-input">
                                                                            ...
                                                                            <input class="form--control include-price" type="number" step="0.01" wire:model.defer="online_service.online_service_price" name="online_service_price" placeholder="{{__('Service price')}}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="single-dashboard-input additional-services">
                                                            ...
                                                            <div class="row g-4 mt-2" wire:ignore>
                                                                <div  class="col-xl-3 col-sm-6">
                                                                    <div class="single-info-input">
                                                                        <label class="label_title">{{ __('Title') }} <span class="text-danger">*</span> </label>
                                                                        <input class="form--control" type="text"  name="additional_service_title[]" wire:model.defer="additional_service_title.0"  placeholder="{{__('Service title')}}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-2 col-sm-6">
                                                                    <div class="single-info-input">
                                                                        <label class="label_title">{{ __('Unit Price') }} <span class="text-danger">*</span> </label>
                                                                        <input class="form--control numeric-value" type="number"  name="additional_service_price[]"  wire:model.defer="additional_service_price.0"  placeholder="{{__('Add Price')}}">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-2 col-sm-6">
                                                                    <div class="single-info-input">
                                                                ...
                                                                @foreach($additional_service_inputs as $key => $value)
                                                                    <div wire:ignore.self >
                                                                        ...
                                                                        <div  class="col-xl-3 col-sm-6">
                                                                            <div class="single-info-input">
                                                                                <label class="label_title">{{ __('Title') }} <span class="text-danger">*</span> </label>
                                                                                <input class="form--control" type="text"  name="additional_service_title[]" wire:model.defer="additional_service_title.{{ $key }}"  placeholder="{{__('Service title')}}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xl-2 col-sm-6">
                                                                            <div class="single-info-input">
                                                                                <label class="label_title">{{ __('Unit Price') }} <span class="text-danger">*</span> </label>
                                                                                <input class="form--control numeric-value" type="number" name="additional_service_price[]"  wire:model.defer="additional_service_price.{{ $key }}"  placeholder="{{__('Add Price')}}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xl-2 col-sm-6">
                                                                            <div class="single-info-input">
                                            ...
                                            <!--        <h4 class="input-title"> {{__('FAQ about the service')}} </h4>-->
                                            <!--        <div class="append-benifits">-->

                                            <!--            <div class="single-dashboard-input benifits" wire:ignore>-->
                                            <!--                <div class="single-info-input mt-3">-->
                                            <!--                    <input class="form--control" type="text" name="benifits[]" wire:model.defer="benifits.0"  placeholder="{{__('Type Here')}}">-->
                                            <!--                </div>-->
                                            <!--            </div>-->
                                            ...
                                            <!--                            <div class="single-info-input mt-3">-->
                                            <!--                                <input class="form--control" type="text" name="benifits[]" wire:model.defer="benifits.{{ $key }}" placeholder="{{__('Type Here')}}">-->
                                            <!--                            </div>-->
                                            <!--                        </div>-->
                                                    ...
                                                    <div class="append-faqs">
                                                        ...
                                                        <div class="single-dashboard-input faqs">
                                                            <div class="single-info-input mt-3">
                                                                ...
                                                                <input class="form--control" type="text" name="faqs_title[]" wire:model.defer="faqs_title.0" placeholder="{{__('Faq Title')}}">
                                                            </div>
                                                            <div class="single-info-input mt-3">
                                                                <label class="label_title">{{__('Description') }}</label>
                                                                <textarea class="form--control textarea-input"  name="faqs_description[]" wire:model.defer="faqs_description.0"  cols="20" rows="2" placeholder="{{__('Faq Description')}}"></textarea>
                                                            </div>
                                                        </div>
                                                           ...
                                                           <div class="row" wire:ignore.self>
                                                               <div class="col-xl-10">
                                                                   <div class="single-dashboard-input faqs">
                                                                       <div class="single-info-input mt-3">
                                                                           <label class="label_title">{{__('Title') }}</label>
                                                                           <input class="form--control" type="text"  name="faqs_title[]" wire:model.defer="faqs_title.{{ $key }}" placeholder="{{__('Faq Title')}}">
                                                                       </div>
                                                                       <div class="single-info-input mt-3">
                                                                           <label class="label_title">{{__('Description') }}</label>
                                                                           <textarea class="form--control textarea-input"   name="faqs_description[]" wire:model.defer="faqs_description.{{ $key }}" cols="20" rows="2" placeholder="{{__('Faq Description')}}"></textarea>
                                                                       </div>
                                                                   </div>
                                                               </div>
                                                               <div class="col-xl-2">
            ...
            <div class="single-settings">
                <div class="btn-wrapper d-flex gap-2 mt-4">
                    ...
                    <button class="dashboard_table__title__btn btn-bg-1 radius-5"
                            ...
                            id="submitBtn" type="submit"  >{{__('Publish')}}
                    </button>
                </div>
            </div>
        </div>
