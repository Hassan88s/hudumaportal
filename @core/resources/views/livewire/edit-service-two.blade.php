                                ...
                                <div class="row g-4">
                                    <div class="col-sm-6">
                                        <div class="single-info-input">
                                            ...
                                            <input class="form--control" id="title" name="title" type="text" placeholder="{{ __('Add title')}}" wire:model.defer="service_edit_title" value="{{ $services->title }}">
                                        </div>
                                        <div class="single-dashboard-input" wire:ignore>
                                            <div class="single-info-input margin-top-30 permalink_label">
                                                ...
                                                <input class="form--control service_slug" id="slug" style="display: none" type="text" wire:model.defer="service_edit_slug" name="slug" value="{{url('/service-list/')}}/{{$services['slug']}}">
                                    ...
                                    <div class="col-sm-12" wire:ignore>
                                        ...
                                        <div class="single-info-input">
                                            ...
                                            <textarea id="summernote"  name="description" class="form--control textarea--form textarea-input" cols="20" rows="2" placeholder="{{__('Type Description')}}">{!! $services->description !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-4">
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="single-info-input">
                                            ...
                                            <select id="category" class="category" wire:model.defer="category" name="category">
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="single-info-input sub_category_wrapper">
                                            ...
                                            <select  id="subcategory" class="subcategory" wire:model.defer="subcategory" name="subcategory">
                                    ...
                                    <!--        <select name="child_category" id="child_category" wire:model.defer="child_category" name="child_category">-->
                                ...
                                <div class="edit-service-wrappers mt-4  ">
                                    <div class="single-dashboard-input service-price-show-hide">
                                        <div class="single-info-input">
                                            ...
                                            <input class="form--control" name="price" type="text" value="{{ $services->price }}" id="service_total_price" disabled>
                                        </div>
                                    </div>
                                </div>
                                 ...
                                 <div class="edit-service-wrappers mt-4  ">
                                    <div class="single-dashboard-input service-price-show-hide">
                                        <div class="single-info-input">
                                            <label class="info-title"> {{__('Delivery Days')}}</label>
                                            <input class="form--control" type="number" name="delivery_days"  id="service_online_delivery_days"  wire:model.defer="services.delivery_days" placeholder="{{__('Delivery Days')}}">
                                        </div>
                                    </div>
                                </div>
                                                                    ...
                                                                    <div class="row align-items-center g-4">
                                                                        ...
                                                                        <div class=" @if($is_service_online === true )  d-none  @elseif($is_service_online === false) @else @if($services->is_service_online == 1)  d-none  @endif @endif col-lg-3 col-sm-6 is_service_online_hide">
                                                                            <div class="single-info-input">
                                                                                ...
                                                                                <input class="form--control include-price" type="text" wire:model.defer="include_service_inputs.{{$key}}.include_service_price" placeholder="{{__('Add Price')}}" name="Price" value="{{ $services->price }}">
                                                                            </div>
                                                                        </div>
                                                                        <div class="@if($is_service_online === true )  d-none  @elseif($is_service_online === false) @else @if($services->is_service_online == 1)  d-none  @endif @endif  col-lg-3 col-sm-6  is_service_online_hide">
                                                                            <div class="single-info-input">
                                                                                <label class="label_title">{{ __('Quantity') }}</label>
                                                                                <input class="form--control numeric-value"   type="text"   wire:model.defer="include_service_inputs.{{$key}}.include_service_quantity" placeholder="{{__('Add Quantity')}}" >
                                                                            </div>
                                                                        </div>
                                                        ...
                                                        <div class="row g-4">
                                                            ...
                                                            <div class="col-lg-4 col-sm-6">
                                                                <div class="single-info-input">
                                                                    ...
                                                                    <input class="form--control" type="number" name="Revisions" id="service_online_revision" wire:model.defer="services.revision"  placeholder="{{__('Revision Times')}}">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-sm-6">
                                                                <div class="single-settings">
                                                                    <div class="single-dashboard-input">
                                                                        <div class="single-info-input">
                                                                            ...
                                                                            <input class="form--control" type="number" name="Service_Price" wire:model.defer="services.price"   placeholder="{{__('Service price')}}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="single-settings">
                                                                    <div class="single-dashboard-input">
                                                                        <div class="single-info-input">
                                                                            ...
                                                                            <input class="form--control change_offline_to_online" name="Service_Price" type="number"  wire:model.defer="services.price" id="service_online_price"
                                ...
                                <div class="col-lg-12">
                                    <div class="available-all-city-area">
                                        ...
                                        <div class="dashboard-switch-single d-flex">
                                            <input class="custom-switch is_service_all_cities_id" id="is_service_all_cities" type="checkbox" name="is_service_all_cities" @if($services['is_service_all_cities'] == 1) checked value="1" @endif />
            ...
            $(document).on("click","#submitBtn", function (e){
                ...
                Livewire.emit("service_category_sub_cat_child_cat",
                    [
                        ...
                        $('#meta_tags').val(),
                        $('#service_online_delivery_days').val(),
