                                            ...
                                            <div class="seller_container">
                                                <ul class="user-profile-chat margin-top-30" id="users">
                                                    @foreach($sellers as $seller)
                                                        ...
                                                        @endphp
                                                        <li>
                                                            <a href="javascript:void(0);" class="chat-toggle"data-id="{{ optional($seller->sellerList)->id }}"data-user="{{ optional($seller->sellerList)->username }}" data-user_image="{{ !empty($user_image) ? $user_image["img_url"] : null }}">
                                                                ...
                                                                <h4 class="chat-author-title"> {{ optional($seller->sellerList)->username  }} </h4>
                                                            </a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                        ...
                                        <div class="seller_container">
                                            <ul class="user-profile-chat margin-top-30" id="users">
                                                @foreach($buyers as $buyer)
                                                    ...
                                                    @endphp
                                                    <li>
                                                        <a href="javascript:void(0);" class="chat-toggle"data-id="{{ optional($buyer->buyerList)->id }}"data-user="{{ optional($buyer->buyerList)->username }}" data-user_image="{{ !empty($user_image) ? $user_image["img_url"] : null }}">
                                                            ...
                                                            <h4 class="chat-author-title"> {{ optional($buyer->buyerList)->username  }} </h4>
                                                        </a>
                                                    </li>
                                                @endforeach
                                            </ul>
