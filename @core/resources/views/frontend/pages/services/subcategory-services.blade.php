...
@section('content')
    ...
    <section class="category-services-area padding-top-70 padding-bottom-100">
        <div class="container">
            ...
            <div class="mb-4">
                <div class="col-lg-12">
                    <h2 class="section-sub-title"><h2 class="section-sub-title">
  {{ sprintf(__("Available Service Sub Categories in") . ' %s', __($subcategory->name)) }}
</h2>
...
@endphp 
                    ...
                    @endif
                @else
                    <div class="alert alert-warning">{{sprintf(__('No services found in') . '%s',__((optional($subcategory)->name)))}}</div>
                @endif
