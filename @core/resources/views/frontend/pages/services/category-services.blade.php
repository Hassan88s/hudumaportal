...
@section('content')
    <section class="category-services-area padding-top-70 padding-bottom-100">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 mb-3">
                    <div class="category_info_new">
                      <h6> <strong>{{ __(strip_tags($category->description)) }}</strong></h6>
            ...
            <div class="mb-2">
                <div class="col-lg-12">
                    <h2 class="section-sub-title">{{ sprintf(__('Available  Services  Sub-Categories  in ') .'%s', __($category->name))  }}</h2>
                </div>
              <div id="services_sub_category_load_wrap ">
                <div class="row">
                     <div class="category-slider dot-style-one pt-5">
    ...
    <div class="single-category">
        ...
        <div class="category-contents">
           <h4 class="category-title"> <a href="{{ route('service.list.subcategory',$sub_cat->slug) }}">{{ __($sub_cat->name) }} </a> </h4>
           <span class="category-para"> {{$sub_cat->total_service}}+ {{__('services')}} </span>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="section-sub-title margin-top-80">{{ sprintf(__('Available Services in ' ).'%s',__($category->name))  }}</h2>
