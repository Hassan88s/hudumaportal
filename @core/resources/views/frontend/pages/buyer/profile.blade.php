...
@section('content')
                        ...
                        <div class="profile-author-contents">
                            <div class="profile-flex-content">
                                ...
                                <div class="profile-contents">
                                    <h4 class="title">
                                        <a href="{{ route('about.buyer.profile',$buyer->username) }}"> {{ getEnterpriseNamewithoutAuth($buyer)}} </a>
                                      ...
                                      @if($buyer->is_company== '1')
                               <div >  <span class="badge bg-warning text-dark">Enterprise</span></div>
                             @endif
                                    @if($job_rating >=1)
                    ...
                    <div class="col-lg-3 col-md-6 margin-top-30">
                        <div class="profile-author-contents">
                            <ul class="profile-about">
                                <li> {{ __('From:') }} <span> {{ optional($buyer->city)->service_city }} </span> </li>
  ...
  @if($job->buyer->is_company== '1')
                             ...
                             @endif
                                ...
                                <div class="award_icons"> <span class="badge bg-danger">Urgent</span></div>
                            @elseif($job->package_id == 2)
                               <div class="award_icons">  <span class="badge bg-warning text-dark">Featured</span></div>
                            @endif @endif</span>
                                                ...
                                                <li class="tag-list">
                                                    <a href="{{ route('about.seller.profile',optional($job->buyer)->username) }}">
                                                        <div class="authors">
                                                            ...
                                                            <a href="{{ route('about.buyer.profile',optional($job->buyer)->username) }}">
                                                            <span class="author-title">{{ getEnterpriseNamewithoutAuth($job->buyer)}}</span>
                                                            </a>
                                                        </div>
                                                    </a>
                                                </li>
