     ...
     <div class="container {{$page_post->page_class}}">
         <div class="row">
             <div class="col-lg-8 col-xl-9">
              @if($page_post->title === 'Referral')
              <style>
                .navbar-area .nav-container .navbar-collapse .navbar-nav li {
                color: #3b3635 !important;
            }
            </style>
                <h2 class="title"> {{ __('Unlock Opportunities with') }}<br><span style="color:">{{ __('HudumaPortal!') }} </span> </h2>
...
Join today and experience the fastest way to get things done.') }}" target="_blank" class="btn btn-dark">
    ...
    font-size: xx-large;
    font-weight: 700;
">{{ __('Invite a Friend & Earn Rewards') }}</h5>
                    <p class="card-text">{{ __('Join us and start referring friends to earn exciting rewards!') }}</p>
                    <a href="{{ url('/login') }}" class="btn btn-warning" style="
    color: white;
    background: #ff6b2c;">{{ __('Login to Get Your Referral Link') }} -></a>
                @endauth
            </div>
        </div>
    </div>
