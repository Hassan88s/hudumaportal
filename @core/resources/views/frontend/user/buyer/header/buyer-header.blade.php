...
$user = \Illuminate\Support\Facades\Auth::guard('web')->user();
    ...
    $enterprisename = \App\Enterprise::where('user_id', \Illuminate\Support\Facades\Auth::guard('web')->user()->id)->first();
    }
@endphp
    ...
    <div class="row g-4 justify-content-between">
        <div class="col-sm-6">
            <div class="dashboard__header__left">
                <h4 class="dashboard__header__title"> @if($enterprisename)
                        {{ $enterprisename->name }} ({{ __('Enterprise') }})
                    @else
                        {{ $user->username }}
                    @endif</h4>
                                                            ...
                                                            <div class="dashboard__header__notification__wrap__list__flex">
                                                                <a class="dashboard__header__notification__wrap__list__contents__title"
                                                                   href="{{ route('buyer.support.ticket.view',$notification->data['last_ticket_id']) }}">
                                                                    ...
                                                                    <div class="dashboard__header__notification__wrap__list__contents">
                                                                        {{ $notification->data['order_ticcket_message'] ?? 'Notification' }}
                                                                        @if(isset($notification->data['last_ticket_id']))
                                                                            #{{ $notification->data['last_ticket_id'] }}
                                                                        @endif
                                                                        <span class="dashboard__header__notification__wrap__list__contents__sub">
                                                                            {{ date('Y/m/d h:i A', strtotime($notification->created_at)) }}
                                                                        </span>
                                            ...
                                            <!--seller order notification -->
                                                ...
                                                <li class="dashboard__header__notification__wrap__list__item">
                                                    <div class="dashboard__header__notification__wrap__list__flex">
                                                        ...
                                                        <a class="dashboard__header__notification__wrap__list__contents__title"
                                                           href="{{ route('seller.gernel.notifications', $notification->id) }}">
