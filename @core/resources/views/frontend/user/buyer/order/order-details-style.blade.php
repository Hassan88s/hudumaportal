...
/* Buyer partial wraps a second nested card — flatten it so we don't get double border */
.dashboard__inner .card.shadow-sm .card .card.shadow-sm,
.dashboard__inner .card.shadow-sm > .card-body > .card {
    border: none !important;
    box-shadow: none !important;
    background: transparent !important;
    margin-bottom: 0 !important;
}
.dashboard__inner .card.shadow-sm .card .card-body,
.dashboard__inner .card.shadow-sm > .card-body > .card > .card-body {
    padding: 0 !important;
}
