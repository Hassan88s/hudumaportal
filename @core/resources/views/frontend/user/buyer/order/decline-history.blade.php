            ...
            <div class="dashboard__inner">
                ...
                <div class="dashboard_table__wrapper dashboard_border  padding-20 radius-10 bg-white">
                    <div class="dashboard_table__title__flex">
                        <h4 class="dashboards-title"> {{ __('Modifications History') }} <br> {{ __('Order ID:') }} <span class="text-info"> {{ $order_id }} </span></h4>
                            ...
                            <table>
                                ...
                                @foreach ($decline_histories as $history)
                                    <tr>
                                        ...
                                        <td><strong>{{ __('Modifications Reason:') }}</strong>{{ $history->decline_reason }}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
