                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dashboard_table__main__actions">
                                                    <a href="{{ route('buyer.order.details',$notification->data['order_id']) }}" class="icon"><i class="fa-regular fa-eye"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endif
                                    ...
                                    @endif
                                     @if(isset($notification->data['data']['id']) && $notification->data['data']['type'] == 'gernalnotifications')
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>
                                                <a class="list-order" href="{{ route('buyer.gernel.notifications', $notification->id) }}">
                                                    <span class="order-icon"> <i class="las la-bell"></i> </span>
                                                    {{ $notification->data['message'] ?? 'Notification' }}
                                                    @if(isset($notification->data['data']['service_id']))
                                                        #{{ $notification->data['data']['service_id'] }}
                                                    @endif
                                                </a>
                                            </td>
                                            <td>
                                                <div class="dashboard_table__main__actions">
                                                    <a href="{{ route('buyer.gernel.notifications', $notification->id) }}" class="icon"><i class="fa-regular fa-eye"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endif
