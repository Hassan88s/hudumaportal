                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-2">
                           ...
                           {{-- <select name="payment_gateway" id="payment_gateway" class="form-control nice-select">
                            ...
                            <option value="">{{ __('Select Payment gateway') }}</option>
                            @php
                                // Existing gateways (dynamic ones with DB check)
                                $all_gateways = [
                                    'paypal','manual_payment','mollie','paytm','stripe','razorpay',
                                    'paystack','marcadopago','instamojo','cashfree','payfast','midtrans'
                                ];
                            @endphp
                            ...
                            {{-- Static Gateways (Always visible) --}}
                        ...
                        <!--Name-->
                           <div class="form-group">
                            <label for="amount" class="label_title">{{ __('Name') }} <span class="text-danger">*</span> </label>
                            <input type="text" class="form-control" name="name" id="Name" placeholder="{{ __('Name') }}" required>
                        </div>
                        <!--Account number-->
                           <div class="form-group">
                            <label for="amount" class="label_title">{{ __('Account Number') }} <span class="text-danger">*</span> </label>
                            <input type="Number" class="form-control" name="number" id="Number" placeholder="{{ __('Number') }}" required>
                        </div>
                        <div class="form-group">
