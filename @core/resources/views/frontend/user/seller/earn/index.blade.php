                ...
                <div class="earn-wrap">
                    ...
                    <div class="wallet-grid">
                        ...
                        <div class="wallet-card wallet-ref">
                            ...
                            <form method="post" action="{{ route('seller.earn.transfer') }}" class="wallet-action">
                                @csrf
                        ...
                        <div class="wallet-card wallet-main">
                            ...
                            <a href="{{ route('seller.wallet.history') }}" class="btn-outline">
