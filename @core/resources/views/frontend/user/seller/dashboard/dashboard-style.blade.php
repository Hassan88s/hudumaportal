<style>
    ...
    /* Subscription Alert restyle */
    .d-alert{border-radius:12px;padding:14px 18px;display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;margin-bottom:16px;border:1px solid transparent;font-size:14px}
    .d-alert.warning{background:var(--d-warning-light);border-color:#fde4a8;color:#78350f}
    .d-alert.info{background:var(--d-info-light);border-color:#bae6fd;color:#075985}
    .d-alert .btn-sm{padding:7px 14px;background:#fff;border-radius:8px;text-decoration:none;font-weight:600;color:var(--d-text);font-size:13px;border:1px solid var(--d-border);transition:all .2s}
    .d-alert .btn-sm:hover{background:var(--d-primary);color:#fff;border-color:var(--d-primary)}
    ...
    /* Notifications */
    .d-notif-list{max-height:380px;overflow-y:auto;padding-right:4px}
    ...
    /* This Month / TODO summary */
    .d-summary-grid{display:grid;grid-template-columns:1fr 1fr;gap:12px}
    .d-summary-item{background:#f9fafc;border:1px solid var(--d-border);border-radius:10px;padding:14px;display:flex;align-items:center;gap:12px}
    .d-summary-item .d-summary-ico{width:40px;height:40px;border-radius:10px;display:flex;align-items:center;justify-content:center;font-size:18px;flex-shrink:0}
    .d-summary-item h5{font-size:11px;color:var(--d-muted);font-weight:600;text-transform:uppercase;letter-spacing:0.3px;margin:0 0 4px}
    .d-summary-item .d-summary-val{font-size:18px;font-weight:700;color:var(--d-text)}

    /* Todo list table */
    .d-todo-table{width:100%;border-collapse:collapse}
    .d-todo-table th{text-align:left;padding:10px 12px;font-size:11px;color:var(--d-muted);font-weight:700;text-transform:uppercase;letter-spacing:0.3px;border-bottom:2px solid var(--d-border)}
    .d-todo-table td{padding:12px;border-bottom:1px solid var(--d-border);font-size:13px;color:var(--d-text)}
    .d-todo-table tr:last-child td{border-bottom:none}
    .d-todo-table .d-todo-id{color:var(--d-text);font-weight:700;text-decoration:none}
    .d-todo-table .d-todo-id:hover{color:var(--d-primary)}

    /* Chart card */
    .d-chart-wrap{position:relative;height:280px}

    /* Bootstrap col compatibility - keep grid working */
