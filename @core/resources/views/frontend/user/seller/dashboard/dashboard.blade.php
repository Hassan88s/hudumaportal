            ...
            <div class="dashboard__inner">
                ...
                <div class="d-referral">
                    <div class="d-referral-title">
                        ...
                        <a href="{{ route('seller.earn') }}" style="margin-left:auto;font-size:12px;font-weight:600;color:#ff6b3d;text-decoration:none;">
                            {{ __('View Earnings →') }}
                        </a>
                    </div>
...
Join today and experience the fastest way to get things done. ' . url('/r/'.Auth::user()->referral_code)) }}" target="_blank" class="wa" title="WhatsApp"><i class="fab fa-whatsapp"></i></a>
