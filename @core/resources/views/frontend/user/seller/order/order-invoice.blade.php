    ...
    <div class="invoice-area">
        <div class="invoice-wrapper">
            ...
            <div style="text-align: right; align-items: end; justify-content: end">
                <span><strong> {{ get_static_option('invoice_title') ?? __('Invoice No:') }} </strong> {{ $order_details->invoice }} </span>
            </div>
            ...
            <div class="invoice-details" style="margin-bottom:100px">
                <div class="invoice-details-flex">
                    <div class="invoice-single-details" style="float:left;">
                        <h4 class="invoice-details-title">  {{ get_static_option('bill_to_title') ?? __('Bill To:') }}</h4>
                        <ul class="details-list">
                            <li class="list"> {{ __('Name:') }} {{ $order_details->name }} </li>
                            <!--<li class="list"> <a href="#"> {{ __('Email:') }} {{ $order_details->email }} </a> </li>-->
                            <!--<li class="list"> <a href="#"> {{ __('Phone:') }} {{ $order_details->phone }}</a> </li>-->
                            <li class="list " style="word-break: break-word"> <a href="#"> {{ __('Address:') }} {{ $order_details->address }}</a> </li>
                        </ul>
                    </div>
                    <div class="invoice-single-details" style="float:right">
                        <h4 class="invoice-details-title">{{ get_static_option('ship_to_title') ?? __('Ship To:') }}</h4>
                        <ul class="details-list">
                             <li class="list"> {{ __('Name:') }} {{ $seller_details->username }} </li>
                            <li class="list"> <strong>{{ __('City') }}: </strong> 
                            @php
                            if(!is_null($service_city)){
                            echo $service_city->service_city;
                            }
                            @endphp
                            
                            </li>
                            <li class="list"> <strong>{{ __('Area') }}: </strong> 
                               @php
                            if(!is_null($service_area)){
                            echo $service_area->service_area;
                            }
                            @endphp
                            </li>
                            <li class="list" style="word-break: break-word"> <strong>{{ __('Address') }}: </strong>{{ $order_details->address }} </li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <span class="data-span"> {{ __('Admin Charge:') }} </span> {{ float_amount_with_currency_symbol($order_details->commission_amount) }} <br>
                                    <span class="data-span">{{ __('Payment Gateway:') }} {{ __(ucwords(str_replace("_", " ", $order_details->payment_gateway))) }}</span> <br>
