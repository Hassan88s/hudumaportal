...
@section('content')
                ...
                <div class="dashboard_accountSettings">
                    ...
                    <div class="dashboard__inner__item dashboard_border padding-20 radius-10 bg-white">
                        ...
                        <div class="dashboard_accountSettings__item">
                            <div class="dashboard_accountSettings__flex">
                                 <div class="dashboard_accountSettings__left">
                                    <h4 class="dashboard_accountSettings__title">{{ __('Portfolio') }}</h4>
                                   
                                </div>
                                <div class="dashboard_accountSettings__btn">
                                    <div class="btn-wrapper" >
                                        <a href="{{ route('seller.portfolio.all') }}" class="dashboard_table__title__btn btn-bg-1 radius-5">{{__('Manage Portfolio')}}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="deleteAccount" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('Request for Delete account') }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="custom-form">
                                    ...
                                    <div class="single-input">
                                        ...
                                        <div class="single-input-select radius-10">
                                            <select class="select2_activation" name="reason" id="reason">
                                                <option value=" My account is not secured"> My account is not secured</option>
 
 <option value="Services are irrelevant">Services are irrelevant</option>
 
 <option value="I have another account">I have another account</option>
 
 <option value="I'm using another platform">I'm using another platform</option>
 <option value="I'm not interested anymore">I'm not interested anymore</option>
