...
@section('content')
                                ...
                                <div class="dashboard_accountProfile__author">
                                    <div class="dashboard_accountProfile__author__flex">
                                        ...
                                        <div class="dashboard_accountProfile__author__contents">
                                            <h4 class="dashboard_accountProfile__author__title"><a href="javascript:void(0)">{{ Auth::guard('web')->user()->username }}</a></h4>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">{{ __('Edit Profiles') }}</h5>
  ...
  <div class="col-12">
                                    <div class="single-input">
                                        <label for="email" class="label_title__postition">{{ __('Username') }} <span class="text-danger">*</span> </label>
                                        <input type="text" class="form--control radius-10" name="username" value="{{ Auth::guard('web')->user()->username }}" placeholder="{{ __('Your username') }}">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="single-input">
                                ...
                                <div class="col-12">
                                    <div class="single-input">
                                        <label for="tax_number" class="label_title__postition">{{ __('Tax Number') }}</label>
...
@endphp
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-12">
                                    <div class="single-input">
                                        <label for="newPassword" class="label_title__postition">{{ __('Website Link') }} <span class="text-danger"></span> </label>
                                        <input type="text" class="form--control radius-10" name="website_url" value="{{ Auth::guard('web')->user()->website_url }}" placeholder="{{ __('Your Website Link') }}">
                                    </div>
                                </div>
