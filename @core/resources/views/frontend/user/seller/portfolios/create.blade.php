...
@endif
                    ...
                    <div class="dashboard_table__wrapper dashboard_border padding-20 radius-10 bg-white">
                       <form action="{{ route('seller.portfolio.store') }}" method="POST" enctype="multipart/form-data" class="p-3 border rounded">
    @csrf
   ...
   <div class="mb-3">
    ...
    <div class="text-end">
        <button type="submit" class="btn btn-primary">
            <i class="fa-solid fa-floppy-disk"></i> {{ __('Save Portfolio')}}
        </button>
    </div>
</form>
