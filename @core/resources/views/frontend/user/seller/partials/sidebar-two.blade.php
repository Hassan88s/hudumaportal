    ...
    <div class="dashboard__left__main">
        ...
        <div class="dashboard__bottom mt-5">
            <ul class="dashboard__bottom__list dashboard-list">
                    ...
                    <a href="{{ route('homepage') }}"><i class="las la-home"></i> {{ __('HomePage') }}</a>
                </li>
                ...
                <li class="dashboard__bottom__list__item @if(request()->is('seller/earn*')) active @endif">
                ...
                <li class="dashboard__bottom__list__item @if(request()->is('seller/availability*') || request()->is('seller/days*') || request()->is('seller/schedules*') || request()->is('seller/add-day*') || request()->is('seller/add-schedule*')) active @endif">
                    <a href="{{ route('seller.availability') }}"> <i class="las la-calendar-check"></i> {{ __('My Availability') }} </a>
                </li>
                 <li class="dashboard__bottom__list__item @if(request()->is('seller/Custom*')) active @endif">
                    <a href="{{ route('seller.Custom') }}"> <i class="las la-briefcase"></i> {{ __('Custom Service') }} </a>
                </li>
                ...
                <li class="dashboard__bottom__list__item @if(request()->is('seller/start-stream*')) active @endif">
                    <a href="{{ route('seller.start.stream') }}"><i class="las la-video"></i> {{ __('Start Streaming') }}</a>
                </li>
                ...
                <li class="dashboard__bottom__list__item @if(request()->is('seller/order/report/list*')) active @endif">
                  ...
                  <li class="dashboard__bottom__list__item @if(request()->is('seller/job-alert-subscribe')) active @endif">
                    <a href="{{ route('seller.job.alert.subscribe')}}"> <i class="las la-bell"></i> {{__('Job Alert Subscription')}} </a>
                </li>
...
$jobs = \Modules\JobPost\Entities\BuyerJob::where('status', 1)
    ->where('is_job_on', 1)
    ->where('dead_line', '>=', $current_date)
    ->whereDoesntHave('sellerViewJobs', function ($list) {
    ...
    ->count();
                ...
                @endif
                    ...
                    <li class="dashboard__bottom__list__item @if(request()->is('seller/project/all')) active @endif  ">
                    <a href="{{ route('seller.project.all')}}"> <i class="las la-user"></i> {{__('Manage Projects')}} </a>
                </li>
