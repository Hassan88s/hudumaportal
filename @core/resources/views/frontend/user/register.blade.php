            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-inner-contents text-center">
                        ...
                        <h2 class="banner-inner-title"> {{ __('Register Now For FREE to Join Us') ?? __('Register') }}</h2>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                @if(get_static_option('seller_register_on_off') === 'on')
                                    <li data-tab="tab_one" class="is_user_seller @if($reg_type === 'seller') active @endif">
                                        <div class="single-tabs-registration">
                                            ...
                                            <div class="contents">
                                                <h4 class="title" id="seller"> {{ __(get_static_option('register_seller_title')) ?? __('Seller') }}</h4>
                                            </div>
                                        </div>
                                    </li>
                                @endif
                                @if(get_static_option('buyer_register_on_off') === 'on')
                                    <li data-tab="tab_two" class="@if($reg_type === 'buyer') active @endif is_user_buyer">
                                        <div class="single-tabs-registration">
                                            ...
                                            <div class="contents">
                                                <h4 class="title" id="buyer"> {{ __(get_static_option('register_buyer_title')) ?? __('Buyer') }}</h4>
                                            </div>
                                        </div>
                                    </li>
                                @endif
