...
class AboutUsWidget extends WidgetBase
{
    ...
    public function frontend_render()
    {
        ...
        $description = __('HudumaPortal provides you with a variety of services that simplify your business and everyday living, You can book a wide range of services offered by well qualified professionals around YOU, anytime.');
