...
<section class="new_tasker_area padding-top-50 padding-bottom-100"
    ...
    <div class="container">
        <div class="new_sectionTitle">
            ...
            <p class="section-para">{{ __($description) }}</p>
        </div>
        <div class="row g-4 mt-4">
@php
$seller_lists = $seller_lists->sortByDesc(function ($seller) {
    return \App\Order::where('seller_id', $seller->id)->where('status', 2)->count();
});
@endphp
                ...
                <div class="new_tasker__single radius-10">
                    <div class="new_tasker__single__flex">
                        ...
                        <div class="new_tasker__single__contents">
                            <h4 class="new_tasker__single__title verified"><a @if(!empty($seller->username)) href="{{ route('about.seller.profile',$seller->username) }}" @endif >{{  $seller->username }}</a></h4>
