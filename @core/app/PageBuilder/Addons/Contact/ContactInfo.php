...
class ContactInfo extends PageBuilderBase
{
    ...
    $description_1 = __($repeater_data['description_1_'][$key]);
    $description_2 = __($repeater_data['description_2_'][$key]);

    // Use __() with a fallback
    $trans = __($title) !== $title ? __($title) : $title;
