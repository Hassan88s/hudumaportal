...
class FrontendFormController extends Controller
{
    ...
    public function custom_form_builder_message(Request $request)
    {
       ...
       $all_field_serialize_data = $validated_data['field_data'];
        ...
        // Sanitize all fields
        foreach ($all_field_serialize_data as $key => $value) {
            // Remove tags and escape special characters
            $all_field_serialize_data[$key] = htmlspecialchars(strip_tags($value), ENT_QUOTES, 'UTF-8');
        }
