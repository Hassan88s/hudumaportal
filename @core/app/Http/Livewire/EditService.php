...
class EditService extends Component
{
    ...
    public  $service_edit_title, $service_edit_slug, $service_edit_video,$service_edit_days;
    ...
    public function rules() {
        ...
        if($this->is_service_online == true ){
            return[
                ...
                'services.description' => 'required|min:50',
...
//=============== Service Include ===============
   ...
   //=============== Service Benefit ===============
    ...
    public function mount(){
        ...
        $this->service_edit_days=$this->services->delivery_days;
    ...
    public function service_category_sub_cat_child_cat($service){
        ...
        $this->service_edit_days=$service[14] ?? '0';
    ...
    public function updateService(){
        ...
        if ($check_service->is_service_online == 1 ) {
            ...
            $prices = array_column($this->include_service_inputs, 'include_service_price');
            $minPrice = min($prices);
                ...
                foreach ($this->include_service_inputs as $key => $value) {
                    if (!empty($value['include_service_title'][$key])) {
                        ...
                        $all_include_service[] = [
                            ...
                            'include_service_quantity' => $value['include_service_quantity'],
                        ];
                    }
                }
            }
